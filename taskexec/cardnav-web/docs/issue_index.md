...
|---|---|---|---|---|
| ISSUE-001 | P1 | done | Port 80 only serves ai.lovemoney.live | docs/issues/ISSUE-001.md |
| ISSUE-002 | P1 | done | Drop README.ru.md; site does not support Russian | docs/issues/ISSUE-002.md |
| ISSUE-003 | P1 | done | Record reusable VPS publish script for 206.119.177.74 | docs/issues/ISSUE-003.md |
